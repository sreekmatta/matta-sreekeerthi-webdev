(function () {
    angular
        ...
        .directive("wbdvSearchRestaurant" ,wbdvSearchRestaurantDir );

    function wbdvSearchRestaurantDir(){
        function linkFunction(scope,element,attributes) {

            var restaurants = [];
            $( "#restaurant-values" ).autocomplete({
                minLength: 0,
                source: restaurants,
                focus: function( event, ui ) {
                    $( "#restaurant-values" ).val( ui.item.label );
                    $( "#restaurant-id-value" ).val( ui.item.desc );
                    return false;
                },
